...
// The day rate is no longer a row of its own (owner decision 2026-08-14) — car and driver-guide show
// as one whole-trip line — so the parity guard is the finished Total, which that line now equals.
const TRIP = [
  'mode=trip',
