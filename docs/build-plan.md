...
- [~] M9 Multi-stop trips — 9.1 schema ✓, 9.2 pricing stub ✓, 9.3 booking model (single|trip, mode-discriminated) ✓ (9.4 endpoint + 9.5 persist + 9.6 smoke pending). _Built autonomously ahead of M7/M8, which need a UI edit / Google key._
