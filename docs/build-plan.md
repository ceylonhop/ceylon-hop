...
- [~] M9 Multi-stop trips — 9.1 schema ✓, 9.2 pricing ✓, 9.3 booking model ✓, 9.4 `POST /bookings/trip` ✓ (9.5 persist + 9.6 smoke pending). _Built autonomously ahead of M7/M8, which need a UI edit / Google key._
