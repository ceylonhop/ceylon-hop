...
describe('RATE_CARD', () => {
  it('exposes the locked v1 rates in cents (incl. 25% markup)', () => {
    ...
    expect(RATE_CARD.perKmCents).toMatchObject({ car: 46, van: 83, van9: 100, van14: 130, custom: 175 });
    expect(RATE_CARD.floorCents).toMatchObject({ car: 2900, van: 5000, van9: 6500, van14: 8500, custom: 11000 });
